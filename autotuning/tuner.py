...
parser.add_argument('-c', '--configurations', type=pathlib.Path, nargs=1,
        default=[pathlib.Path('autotuning/kernel_configs')], help='path to save the configurations for the tunable process to read them. Default = autotuning/kernel_configs/')
parser.add_argument('-t', '--tunables', type=argparse.FileType('r'), nargs=1,
        default=[open('autotuning/tunables.csv', 'r')], help='csv file that contains the tunable parameters. Default = autotuning/tunables.csv')
parser.add_argument('-r', '--results', type=argparse.FileType('a'), nargs=1,
        default=[open('autotuning/results.txt', 'a')],
